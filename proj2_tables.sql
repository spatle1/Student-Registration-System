...
create table logs (logid number(20) primary key, who varchar2(40) not null, time date not null,
table_name varchar2(20) not null, operation varchar2(20) not null, key_value varchar2(14));
